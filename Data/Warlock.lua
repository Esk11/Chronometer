...
function Chronometer:WarlockSetup()
	...
	self:AddTimer(self.SPELL, BS["Banish"],                 20, 1,0,0, { gr=1, rc=true, d={rs=10}, cr="GREEN" })
	self:AddTimer(self.SPELL, BS["Corruption"],             18, 1,0,0, { rc=true, d={rt={12,15}}, cr="MAROON" })
	self:AddTimer(self.SPELL, BS["Curse of Agony"],         24, 1,0,0, { gr=2, rc=true, cr="ORANGE" })
	self:AddTimer(self.SPELL, BS["Curse of Doom"],          60, 1,0,0, { gr=2, rc=true, cr="GREEN" })
	...
	self:AddTimer(self.SPELL, BS["Curse of Shadow"],       300, 1,0,0, { gr=2, rc=true, cr="PURPLE" })
	...
	self:AddTimer(self.SPELL, BS["Curse of the Elements"], 300, 1,0,0, { gr=2, rc=true, cr="BLUE" })
	...
	self:AddTimer(self.SPELL, BS["Immolate"],               15, 1,0,0, { rc=true, mc=BS["Conflagrate"], cr="YELLOW" })
	...
	self:AddTimer(self.SPELL, BS["Siphon Life"],            30, 1,0,0, { rc=true, cr="GREEN" })
	...
	self:AddTimer(self.EVENT, BS["Shadow Vulnerability"],   12, 1,0,0, { cr="MAGENTA", xn=BS["Shadow Bolt"] })
	self:AddTimer(self.EVENT, BS["Shadow Trance"],          10, 0,1,1, { cr="MAGENTA", a=1, xn=BS["Nightfall"] })
	self:AddTimer(self.EVENT, BS["Soul Siphon"],            10, 0,1,1, { cr="GREEN", a=1, xn=BS["Drain Soul"] })
	self:AddTimer(self.EVENT, BS["Curse of Agony"],         24, 1,0,0, { xn=BS["Curse of Shadow"], cr="ORANGE" })
	self:AddTimer(self.EVENT, BS["Curse of Agony"],         24, 1,0,0, { xn=BS["Curse of the Elements"], cr="ORANGE" })
	self:AddTimer(self.EVENT, BS["Curse of Agony"],         24, 1,0,0, { xn=BS["Curse of Recklessness"], cr="ORANGE" })
end
